...
public class LoginController {
    ...
    private void Login(ActionEvent event) throws Exception{
        //To Write log in code here

        if (txtUsername.getText().equals("Cosmas") && txtPassword.getText().equals("punkcozy")){
            ...
            lblLoginWarning.setText(" \uD83D\uDE12 Invalid Log in Credentials");
            }
...
public class LoginController implements Initializable {
    ...
    public String getUserOriginalName() throws SQLException  {
        ...
        try {
            ...
            Connection conn = SqlLiteConnection.dbConnector(); // this is the database connection
    ...
    public void handleBtnLogin (ActionEvent event) throws SQLException {
        ...
        try {
            ...
            if (loginModel.isLogin(usernameHash(),passwordHash())){
                ...
                Home employeeInfoController = (Home) loader.getController();
